...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self._ddStati = ft.Dropdown(label="Seleziona uno stato")
        self._controller.popolaStati()
        self._btnRaggiungibili = ft.ElevatedButton(text="Calcola raggiungibili", on_click=self._controller.handleRaggiungibili)
        self._btnRaggiungibili.disabled = True
